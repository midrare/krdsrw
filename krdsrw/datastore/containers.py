...
class FixedMap(Value):
    def __init__(
        ...
        self._optional_templates: typing.Dict[str,
            ValueFactory] = (dict(optional) if optional else {})
...
class NameMap(Value):
    def __init__(self):
        self._value: TemplatizedDict[str,
            NamedValue] = TemplatizedDict(self._make_value)
...
TIMER_AVERAGE_CALCULATOR_TEMPLATE = ValueFactory(
    ...
    ValueFactory(Array, TIMER_AVERAGE_CALCULATOR_DISTRIBUTION_NORMAL_TEMPLATE),
